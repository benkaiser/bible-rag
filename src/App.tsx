...
function App() {
  ...
  return (
    <div className="app">
      <a href="https://github.com/benkaiser/bible-rag" className="github-corner" aria-label="View source on GitHub" target="_blank" rel="noopener noreferrer">
        <svg width="80" height="80" viewBox="0 0 250 250" style={{fill:'#3a2d1e', color:'#f5f3ef', position: 'absolute', top: 0, border: 0, right: 0, zIndex: 100}} aria-hidden="true">
          ...
          <path d="M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C ## 194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C ## 157.9,116.9 156.7,120.9 152.7,124.9 L ## 141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z" fill="currentColor"/>
        </svg>
      </a>
      <header>
        <h1>Bible RAG</h1>
        <p className="subtitle">AI-powered Bible study grounded in the <a href="https://berean.bible/" target="_blank" rel="noopener noreferrer">Berean Standard Bible</a> — every answer verified against the text</p>
      </header>
